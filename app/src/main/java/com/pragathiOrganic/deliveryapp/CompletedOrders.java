...
public class CompletedOrders extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rc.setLayoutManager(new LinearLayoutManager(CompletedOrders.this));

        pullToRefresh = findViewById(R.id.pullRefresh);
        pop = new ProgressDialog(CompletedOrders.this);
        ...
        pullToRefresh.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                if(orderArrayList.size()==0)
                    Toast.makeText(CompletedOrders.this, "No orders available", Toast.LENGTH_SHORT).show();
        ...
        OrderAdapter adapter = new OrderAdapter(CompletedOrders.this, orderArrayList);
